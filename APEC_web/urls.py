...
#    url(r'^admin/', admin.site.urls),
    ...
    url(r'^estmform/$', estmviews.ESTM_View.as_view(), name='ESTM'),
    url(r'^estmform/$', estmviews.ESTM_View.as_view(), name='APEC'),
    url(r'^estmform/$', estmviews.ESTM_View.as_view(), name='FEG'),
