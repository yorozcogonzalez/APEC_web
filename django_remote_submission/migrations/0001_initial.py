    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', model_utils.fields.StatusField(choices=[('initial', 'initial'), ('submitted', 'submitted'), ('success', 'success'), ('failure', 'failure')], default='prep', help_text='The current state of the program', max_length=100, no_check_for_status=True, verbose_name='Job State')),
                ...
                ('estm_data', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='ESTM.ESTM_object')),
